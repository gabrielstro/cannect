...
import { mainSectionStyles } from "./main.styles";
import CollapseText from "../collapse-text/collapseText";
import CardInfo from "../card-info/cardInfo";
import CardCostumer from "../card-costumer/cardCostumer";
    ...
    <div className="overflow-x-hidden">
      <section className={`${mainSectionStyles()} flex justify-between`}>
        ...
        <div className="flex gap-5">
          ...
          <Image src={'/banner-image-1.webp'} alt={""} width={383} height={374} className="h-full mt-[-34px] hidden lg:block" />
      ...
      <section className={`${mainSectionStyles()} flex gap-32 lg:`}>
      ...
      <section className={`${mainSectionStyles()} lg:px-4`}>
